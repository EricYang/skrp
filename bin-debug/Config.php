...
class Config{  
    ...
    const dbSch = "localhost:3306,ManaInfo,root,db88u88"; //server name(:port), db name, login id, login password (中間不可空白)
    const db = "localhost:3306,School_{0},root,db88u88"; //server name(:port), db name, login id, login password (中間不可空白)    
